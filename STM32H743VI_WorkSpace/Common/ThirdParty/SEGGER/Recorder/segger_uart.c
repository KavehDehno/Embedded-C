...
Modified by Kaveh Dehno to be used with STM32H743VI
--------- END-OF-HEADER ---------------------------------*/
...
//#define OS_FSYS 8000000L    // MCU core frequency of Flasher STM32H743VI
#define OS_FSYS 240000000L
#define RCC_BASE_ADDR       0x58024400

#define OFF_AHB1ENR         0x0D8        // AHB1 peripheral clock enable register
#define OFF_AHB2ENR         0x0DC        // AHB2 peripheral clock enable register
#define OFF_AHB4ENR         0x0E0        // AHB4 peripheral clock enable register
#define OFF_APB1ENR         0x0E8        // APB1 peripheral clock enable register
#define OFF_APB2ENR         0x0F0        // APB2 peripheral clock enable register
...
#define GPIO_BASE_ADDR      GPIOA_BASE_ADDR		// USART2 runs on GPIOA
...
#define USART_RX_ERROR_FLAGS  0xB     // Parity, framing, overrun error flags (SR) - 0xB mean bits 1,2 and 4 of Status Register
...
#define USART_TXE               7     // Transmit data register empty (Does NOT indicate that byte has already been sent just indicates that it has been copied to the shift register) (SR)
#define USART_TXEIE             7     // Transmit data register empty interrupt enable (CR1)
